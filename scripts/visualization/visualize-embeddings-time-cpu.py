#!/usr/bin/env python3
"""
CPU UMAP visualization of perch embeddings with temporal encoding.
...
try:
    ...
    raise ImportError(
        ...
        "Install: pip install umap-learn datashader scikit-learn"
    )
...
def main():
    ...
    console.print(Panel.fit("→ Running CPU UMAP (umap-learn)...", border_style="cyan"))
    umap = UMAP(
        n_components=2,
        metric="euclidean",
